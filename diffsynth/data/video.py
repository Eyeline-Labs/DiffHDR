...
class VideoData:
    def __init__(self, video_file=None, image_folder=None, height=None, width=None, crop_and_resize=True, **kwargs):
    ...
    def __getitem__(self, item):
        ...
        if self.height is not None and self.width is not None:
            if (self.height != height or self.width != width) and self.crop_and_resize:
